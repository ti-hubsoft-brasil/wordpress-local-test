...
function scb_add_consent_default()
{
    ...
    <script>
        ...
        gtag('consent', 'default', {
            'analytics_storage': 'granted',     // Bloqueia Google Analytics
            'ad_storage': 'granted',            // Bloqueia Google Ads
            'ad_user_data': 'granted',          // Bloqueia dados de usuário para Ads
            'ad_personalization': 'granted',    // Bloqueia personalização de Ads
...
function scb_cookie_config()
{
    ...
    <script>
        ...
        function initSilktideCookieBanner() {
            // // Se o usuário ainda não tem o cookie de escolha do Silktide
            // if (!document.cookie.includes('stcm_settings')) {
            //     silktideCookieBannerManager.setAllPreferences(true);
            // }
